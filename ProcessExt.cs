...
{
    /// <summary>
    /// Based on https://stackoverflow.com/questions/394816/how-to-get-parent-process-in-net-in-managed-way
    /// </summary>
    public static class ProcessExt
    {
        ...
        public static Process GetParentProcess(IntPtr handle)
        {
            ...
            int returnLength;
            int status = ParentProcessUtilities.NtQueryInformationProcess(handle, 0, ref pbi, Marshal.SizeOf(pbi), out returnLength);
            if (status != 0)
